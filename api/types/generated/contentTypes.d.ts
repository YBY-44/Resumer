...
export interface ApiExperiencessExperiencess extends Struct.SingleTypeSchema {
  collectionName: 'experiences';
  info: {
    singularName: 'experiencess';
...
export interface ApiUserResumeUserResume extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Experience: Schema.Attribute.Component<'experiences.experience', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::experiencess.experiencess': ApiExperiencessExperiencess;
